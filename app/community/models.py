...
class Community(models.Model):
    ...
    community_admin = models.ForeignKey(EmpactUser, related_name='community', on_delete=models.DO_NOTHING)
    community_name = models.CharField(max_length=100, )
    verified = models.BooleanField(default=True)
    community_description = models.CharField(max_length=400, )  
    country = models.CharField(max_length =50, default='Kenya')
    members = models.ManyToManyField(EmpactUser, related_name='communitymember',  blank=True)
    ...
    def projectsCount(self):
        projects_count = Project.objects.filter(community__community_id=self.community_id).count()
...
class Project(models.Model):
    ...
    project_coodinator =models.ForeignKey(EmpactUser, related_name='project', on_delete=models.DO_NOTHING)  
    community = models.ForeignKey('Community', related_name='project', on_delete=models.CASCADE) 
...
class CommunityMedia(models.Model):
    commuinty = models.ForeignKey('Community', related_name='community', on_delete=models.CASCADE) 
...
class CommunityComment(models.Model):
    ...
    owner = models.ForeignKey(EmpactUser, related_name='communitycomments', on_delete=models.CASCADE)
    post = models.ForeignKey('Community', related_name='communitycomments', on_delete=models.CASCADE)
