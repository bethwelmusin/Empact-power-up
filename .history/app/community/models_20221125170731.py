...
class Project(models.Model):
    ...
    project_coodinator =models.OneToOneField(EmpactUser, related_name='projects', on_delete=models.DO_NOTHING)  
    commuinty = models.ForeignKey(EmpactUser, related_name='community', on_delete=models.CASCADE) 
