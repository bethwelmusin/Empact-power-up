...
class BlogUrlsTests(SimpleTestCase):
    ...
    def test_add_post_comment_is_resolved(self):
        ...
        self.assertEquals(resolve(comment_post_url).func.view_class, AddBlogApiView)
        self.assertEquals(resolve(get_post_comment_url).func.view_class, AddBlogApiView)