...
class BlogUrlsTests(SimpleTestCase):
    ...
    def test_addD_new_blog_is_resolved(self):
        url = reverse('add-new-blog') # This the url reverse name for {all-published-blogs} url path.
        
        self.assertEquals(resolve(url).func.view_class, AddBlogApiView)