...
app_name='blog'
urlpatterns = [
    path('all-published-blogs/', api_views.GetAllPublishedBlogApiView.as_view(), name='all-published-blog'),
    path('blog-detail/<int:blogId>/', api_views.BlogDetailApiView.as_view(), name='blog-detail'),
    path('add-blog/<str:userId>/', api_viewsAddBlogApiView.as_view(), name='add-new-blog'),
