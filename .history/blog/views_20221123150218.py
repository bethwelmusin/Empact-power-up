...
class AddPostCommentApiView(APIView):
    ...
    def post(self,request,postId):
        serilizer = AddCommentSerializer(data=request.data)
        ...
        if serializer.is_valid():
            ...
            created_at = timezone.now().astimezone().strftime('Y-m-d')
            comment = Comment.objects.create(body=body,image_url=image_url,user_id=user_id,created_at=created_at)
    ...
    def get(self,request,postId):
        comment = Comment.objects.get(post__post_id=postId)
