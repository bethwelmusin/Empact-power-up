            ...
            with transaction.atomic():
                ...
                if not user.exists():
                    try:
                        ...
                        empactUser  = EmpactUser(user=user,first_name=first_name,last_name=last_name,mobile_number=mobile_number,email=email,profile_pic_url=profile_pic_url,member_type=member_type)
