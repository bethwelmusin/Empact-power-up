...
class RegisterAPIView(APIView):
    ...
    responses={
            '200': EmpactUserSerializer,
            '400': ErrorSerializer,
        },
        operation_description = '  An api endpoint to register any Empact user. Email should be unique'
)
...
class LoginAPIView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            ...
            operation_description = ' Takes a username and a password and the returns an access type JSON web'
    )
    def post(self, request):
        print(request.data)
